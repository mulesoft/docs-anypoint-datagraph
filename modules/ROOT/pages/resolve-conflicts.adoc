...
When you add an API schema that has a type name that already exists within your unified schema, the DataGraph raises an error. You must resolve this error before continuing.
