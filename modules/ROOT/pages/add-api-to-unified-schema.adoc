...
. Optionally, add a truststore to allow your API to be reached your unified schema.
+
...
You can also add a truststore to allow your API to be reached your unified schema.
