...
After you've added an API schema to DataGraph, you can update the version of the API source any time you like. Note that DataGraph supports only `stable` state API versions. 
