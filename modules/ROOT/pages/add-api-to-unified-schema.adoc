...
[[upate-an-api-version]]
== Update an API Version

After you've added an API schema to DataGraph, you can later update the version of the API source. 

When you choose a new version of an API, DataGraph lists any changes you've made to the current version that it can't automatically apply to the new version.

For any changes DataGraph can't automatically apply, you'll have the option to manually apply these changes before you complete the update. 
