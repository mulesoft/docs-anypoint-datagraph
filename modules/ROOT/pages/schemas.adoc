...
Mutations are requests that modify and fetch data. Mutation methods represent the POST, PUT, DELETE, and PATCH endpoints you’ve defined in your API specification. 
...
Input types are POST, PUT, DELETE, and PATCH request objects you use to modify information in your unified schema when you run mutations.
