...
Mutations are requests that modify and fetch data. Mutation methods represent the POST, PUT, DELETE, and UPDATE endpoints you’ve defined in your API specification. 
