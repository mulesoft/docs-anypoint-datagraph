...
A query type is the entry point to your API schema when you make a request. These types contain the query methods that represent the GET endpoint you’ve defined in your API specification.
