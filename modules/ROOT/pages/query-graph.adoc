...
<1> Select *User one of my existing applications* if you alredy have a client application authenticated to send requests.
...
. In the left side of the screen, start typing the query using the in-line autocomplete feature.
+
