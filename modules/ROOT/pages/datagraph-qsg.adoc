...
Mutations are operations you use to add, update, and delete data objects. In GraphQL, mutation operations represent the POST, PUT, DELETE, and HTTP methods that you’ve defined in your REST API specification.
