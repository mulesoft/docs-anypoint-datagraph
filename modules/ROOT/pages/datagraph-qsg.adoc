...
. Click *History* to access this same query (or others) later.
. To use this query in an external application, from the actions menu (*...*), click *Copy & Share Endpoint* to copy both the query and the automatically generated endpoint.
+
