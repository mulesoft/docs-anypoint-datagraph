...
+
image::datagraph-qsg-add-api.png[50%,50%]
...
+
image::datagraph-qsg-configure-api.png[]
+
...
+
image::datagraph-qsg-api-authentication.png[]
+
...
+
image::datagraph-qsg-preview-schema.png[]
+
...
+
image::datagraph-qsg-preview-search.png[]
...
+
image::datagraph-qsg-enable-collaboration.png[]
+
...
+
image::datagraph-qsg-add-api-status.png[75%,75%]
+
...
image::datagraph-qsg-rename-type.png[]
...
+
image::datagraph-qsg-rename-type-field.png[60%,60%]
...
+
image::datagraph-qsg-visible-object-type.png[]
...
+
image::datagraph-qsg-link-configuration.png[]
+
...
+
image::datagraph-qsg-link-added.png[]
...
+
image::datagraph-qsg-merge-selection.png[]
...
+
image::datagraph-qsg-diff-view-hidden-fields.png[]

.
. Click *Preview merge result*:
+
image::datagraph-qsg-merge-preview-result.png[]
+
...
+
image::data-graph-qsg-request-query-access.png[70%,70%]

. Click *Next*.
. In the *Create a new application* window, complete the fields:
+
image::datagraph-qsg-create-query-application.png[70%,70%]
...
+
image::datagraph-qsg-explore-schema-docs.png[]
+
...
+
image::datagraph-qsg-query-autocompletion.png[]
...
+
image::datagraph-qsg-two-apis.png[]
+
...
+
image::datagraph-qsg-copy-query.png[]
