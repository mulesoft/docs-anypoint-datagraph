...
+
The primary key is one field of your object type that uniquely identifies a single record of that object type. Some object types use two primary keys—these are called _composite keys_.
. Click *Confirm*.
