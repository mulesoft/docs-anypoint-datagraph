...
. Click Usage Metrics.
+
image::datagraph-usage-metrics.png["Overview dashboard displaying DataGraph usage statistics and performance metrics"]
...
image::datagraph-custom-graph.png["Custom monitoring visualization displaying request volume metrics grouped by client ID"]
