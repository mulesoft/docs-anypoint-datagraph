...
. From Anypoint Monitoring, and select *Custom dashboards*.
. Click *+New Dashboard*, add then select the graph. 
...
. Click *Apply changes*.
. Open the timepicker, choose a timeframe, and click *Confirm*.
