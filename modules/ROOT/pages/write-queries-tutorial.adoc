...
image::schema-explorer-query-method.png["Schema explorer interface displaying available query operation methods"]
...
image::schema-explorer-fields.png["Schema explorer showing field definitions and data types"]
...
image::schema-explorer-mutation-method.png["Schema explorer interface displaying available mutation operation methods"]
...
image::schema-explorer-mutation-fields.png["Schema explorer showing CustomerInput type field definitions"]

Notice that the address field has data from the `AddressInput` input type:

image::schema-explorer-mutation-fields2.png["Schema explorer displaying AddressInput type field definitions"]
