= API Semantic Extensions for Anypoint DataGraph

The following guide defines extensions for REST API specs that are required by DataGraph. 

If you're building or editing REST APIs that you want to include in the DataGraph unified schema, add these semantic extensions where appropriate. 
