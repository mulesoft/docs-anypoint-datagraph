...
+
image::datagraph-qsg-response-logs.png["Query response logs interface displaying request details and timestamps"]
...
+
image::search-logs.png["Search interface with filterable fields for query response logs"]
. Click *Apply*.
