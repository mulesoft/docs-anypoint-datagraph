...
+
image::merge-selection.png["Type merge configuration interface with order type selection"]
+
...
+
image::merge-preview.png["Preview interface showing merged type structure"]
...
image::merged-type-results.png["Interface showing successful type merge confirmation"]
