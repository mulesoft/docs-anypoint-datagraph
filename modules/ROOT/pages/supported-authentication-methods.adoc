...
* Optionally, you can also provide a truststore that contains the root CA.

// [add screenshot]

Anypoint Platform stores keystore and truststore in xref:anypoint-security::index-secrets-manager.adoc[Secrets Manager].
