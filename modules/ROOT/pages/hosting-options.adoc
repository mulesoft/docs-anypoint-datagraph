...
If you’re unable to use port 8082 on a Shared Load Balancer, you must set a new URL for Anypoint DataGraph to use on a CloudHub dedicated load balancer (DLB). Refer to (*link coming soon*) for instructions.
