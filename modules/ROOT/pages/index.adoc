...
To use Anypoint DataGraph, you must meet the following requirements:

* You must have an Anypoint Platform account.
* You must have an Anypoint DataGraph license for your Anypoint Platform organization.
