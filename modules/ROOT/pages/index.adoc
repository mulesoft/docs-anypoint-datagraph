...
== The Anypoint DataGraph Best Practices Ruleset

The DataGraph Best Practices Ruleset is a collection of governance rules you can add as a dependency to any API project you want to later use in Anypoint DataGraph. The ruleset is a collection of messages to help you ensure your API project adheres to DataGraph best practices. The ruleset is publicly available in Exchage. You add the ruleset as a dependency to API specifications in Design Center API Designer.
