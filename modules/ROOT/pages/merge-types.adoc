...
You can merge two input types only when all fields between the types match with the same names and types. Both types must have the same number of fields and cannot contain subsets of fields.
