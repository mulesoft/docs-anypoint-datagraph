...
image::query-trace-details.png["Query trace interface showing execution steps and timing information"]
...
+
image::datagraph-qsg-query-traces.png["Query execution trace view with enabled monitoring options"]
+
