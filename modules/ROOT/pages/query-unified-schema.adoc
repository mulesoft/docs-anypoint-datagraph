...
.. From the *Header Name* drop-down list, select a header name.
.. In the *Header Value* field, add a header value.
.. Click *+Add Header* to specify additional header name and value pairs for other APIs. 
.. Click *Save*. 
